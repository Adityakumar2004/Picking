...
# Add IsaacLab root to Python path for scripts imports
...
def make_env(video_folder:str | None =None, output_type: str = "numpy"):
    ...
    gym.register(
        id=id_name,
        entry_point="scripts.peg_hole_task.testing_controllers.factory_env_task_space:RobotEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point":"scripts.peg_hole_task.testing_controllers.factory_env_task_space:RobotEnvCfg",
        },
    )
