...
def main():
    ...
    avg_reward = TestingAgent(env, device, args_cli.num_envs, agent, checkpoint_path = checkpoint_path, num_episodes=6, recording_enabled=env.enable_recording, sim_step_func=log_values, file_path = file_path_csv)
